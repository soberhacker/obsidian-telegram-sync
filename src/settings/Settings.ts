...
export class TelegramSyncSettingTab extends PluginSettingTab {
	...
	display(): void {
		...
		donationDiv.appendChild(paypalButton("https://www.paypal.com/donate/?hosted_button_id=VYSCUZX8MYGCU"));
		donationDiv.appendChild(buyMeACoffeeButton("https://www.buymeacoffee.com/soberhacker"));
